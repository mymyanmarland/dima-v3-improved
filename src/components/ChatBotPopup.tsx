  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-[9999] group cursor-pointer"
      ...
      {isOpen && (
        <div 
          className="fixed bottom-[5.5rem] left-6 z-[9999] w-[370px] max-w-[calc(100vw-2rem)] h-[520px] max-h-[72vh] flex flex-col overflow-hidden animate-scale-in"
          style={{
            borderRadius: "1.5rem",
