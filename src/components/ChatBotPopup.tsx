  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-1/2 -translate-y-1/2 left-4 z-[9999] group cursor-pointer"
      ...
      {isOpen && (
        <div 
          className="fixed top-1/2 -translate-y-1/2 left-20 z-[9999] w-[370px] max-w-[calc(100vw-6rem)] h-[520px] max-h-[80vh] flex flex-col overflow-hidden animate-scale-in"
          style={{
            borderRadius: "1.5rem",
