  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-20 right-4 z-[9999] group cursor-pointer"
      ...
      {isOpen && (
        <div 
          className="fixed top-36 right-4 z-[9999] w-[370px] max-w-[calc(100vw-2rem)] h-[520px] max-h-[72vh] flex flex-col overflow-hidden animate-scale-in"
          style={{
            borderRadius: "1.5rem",
